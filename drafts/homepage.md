...
You can obtain SOL in multiple ways. Two common methods are:  
...
2. **Transfer SOL from Another Exchange**: If you already have SOL on an exchange (like Binance, FTX, or Coinbase), withdraw it to your Phantom wallet address.  
...
## **3. Buying \$OCN via Revolut (A Simpler & Often Cheaper Option)**

Revolut is a popular financial app that often offers lower fees or taxes for buying cryptocurrencies (depending on your region). Here’s how to use Revolut in combination with a Solana wallet like **Phantom** or **Solflare**.

### **Step 1: Download & Sign Up for Revolut**  
1. **Create an Account**: Download the **Revolut** app from the App Store or Google Play.  
2. **Identity Verification**: Revolut requires standard KYC checks. You’ll need to submit a valid ID (passport, driver’s license, or national ID), and possibly a selfie or proof of address.  
3. **Link a Payment Method**: Attach your bank account, debit/credit card, or other supported payment options within Revolut.

### **Step 2: Buy Solana (SOL) on Revolut**  
1. **Navigate to the Crypto Section**: Inside the Revolut app, look for “Crypto” or “Invest.”  
2. **Select Solana (SOL)**: Find Solana on the list and tap “Buy.”  
3. **Choose Your Payment Method**: You can pay using your Revolut balance or linked bank card.  
4. **Enter the Amount**: Decide how much SOL you want to purchase. Remember to account for the 0.1 SOL you must keep for fees if you plan to swap for **\$OCN**.  
...
### **Step 3: Transfer SOL from Revolut to Your Wallet**  
1. **Get Your Solana Wallet Address**:  
   - **Phantom**: Open Phantom and copy the address from the main screen.  
   - **Solflare**: Open Solflare and tap “Receive” to copy the address.  
2. **Go Back to Revolut**: Find your newly purchased SOL.  
3. **Transfer/Send SOL**: Tap “Withdraw” or “Send,” then paste the wallet address you copied from Phantom or Solflare.  
4. **Confirm Transaction**: Check that the address is correct and confirm.  
5. **Wait for Completion**: Solana transactions are usually quite fast, but it may take a minute or two for the SOL to appear in your wallet.

### **Step 4: Swap SOL for \$OCN in Your Wallet**  
Once the SOL is in your Phantom or Solflare wallet, **follow the Swap instructions** in the relevant wallet section above. Simply choose **\$OCN** as the target token and swap.
